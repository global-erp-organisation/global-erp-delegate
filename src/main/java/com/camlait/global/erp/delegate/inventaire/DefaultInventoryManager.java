...
public class DefaultInventoryManager implements InventoryManager {
	...
	public Magasin retrieveStore(String storeId) throws DataStorageException {
		...
		return s == null ? null : storeLazyInit(s);
	}

	@Override
	public <T> T retrieveStore(Class<T> clazz, String storeId) throws DataStorageException {
		// TODO Auto-generated method stub
		return null;
	}
	...
	private Magasin storeLazyInit(Magasin m) {
