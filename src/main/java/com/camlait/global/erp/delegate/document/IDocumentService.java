...
public interface IDocumentService {
	 ...
	 * @return Document cherché.
	 */
	<T> T obtenirDocument(Class<T> entityClass, String codeDocument)
			throws GlobalErpServiceException, ClassCastException;
	 ...
	 */
	void supprimerDocument(Long documentId) throws GlobalErpServiceException, ClassCastException;
	 ...
	 * @return
	 */
	<T extends DocumentDeVente> double valeurMarge(T  document);

	double obtenirPrixUnitaire(Long partenaireId, Long produitId);

	double obtenirPrixUnitaireMarge(Long partenaireId, Long produitId);
