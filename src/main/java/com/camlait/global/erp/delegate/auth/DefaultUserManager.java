...
public class DefaultUserManager implements UserManager {
    ...
    @Override
    public Utilisateur addUser(Utilisateur user) throws DataStorageException {
        return userDao.save(user);
    }

    @Override
    public Utilisateur updateUser(Utilisateur user) throws DataStorageException {
        final Utilisateur u = retrieveUser(user.getUtilisateurId());
        return userDao.saveAndFlush(user.merge(u));
    }

    @Override
    public Utilisateur retrieveUser(String userCode) throws DataStorageException {
    ...
    @Override
    public Boolean removeUser(String userCode) throws DataStorageException {
    ...
    @Override
    public Page<Utilisateur> retrieveUsers(String keyWord, Pageable page) throws DataStorageException {
    ...
    @Override
    public Groupe addGroup(Groupe group) throws DataStorageException {
        return groupDao.save(group);
    }

    @Override
    public Groupe updateGroup(Groupe group) throws DataStorageException {
        final Groupe g = retrieveGroup(group.getGroupeId());
        return groupDao.saveAndFlush(group.merge(g));
    }

    @Override
    public Groupe retrieveGroup(String groupId) throws DataStorageException {
    ...
    @Override
    public Boolean removeGroup(String groupId) throws DataStorageException {
    ...
    @Override
    public Page<Utilisateur> retrieveGroups(String keyWord, Pageable page) throws DataStorageException {
        // TODO Auto-generated method stub
        return null;
    }
    ...
    @Override
    public Ressource addResource(Ressource resource) throws DataStorageException {
        return ressourceDao.save(resource);
    }

    @Override
    public Ressource updateResource(Ressource resource) throws DataStorageException {
        final Ressource r = retrieveResource(resource.getRessourceId());
        return ressourceDao.saveAndFlush(resource.merge(r));
    }

    @Override
    public Ressource retrieveResource(String ressourceId) throws DataStorageException {
    ...
    @Override
    public Boolean removeResource(String resourceId) throws DataStorageException {
    ...
    @Override
    public Page<Ressource> retrieveResources(String keyWord, Pageable page) throws DataStorageException {
        // TODO Auto-generated method stub
        return null;
    }
