...
public interface BmqManager {
     ...
     * 
     * @param bmqId Bmq identifier use to generate.
     ...
     * 
     * @param bmqId Bmq identifier to remove.
     ...
     * 
     * @param bmqid Given Bmq identifier.
     ...
     * @param bmqId Bmq identifier that belongs to the tax
