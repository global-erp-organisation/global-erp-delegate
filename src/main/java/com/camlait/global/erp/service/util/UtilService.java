...
public class UtilService implements IUtilService {
     ...
     * 
     * @param entite Entite associe au code.
    ...
    private String dernierId(Entite entite) {
        ...
        if (entite instanceof Document) {
            ...
            List<Partenaire> partenaires = partenaireDao.obtenirDernierPartenaire(type, new PageRequest(0, 1)).getContent();
            ...
            List<Localisation> localisations = localisationDao.obtenirDernierLocal(type, new PageRequest(0, 1)).getContent();
        ...
        return type.getType().toUpperCase() + (Utility.convertToLong(StringUtils.removeStart(dernierCode, type.getType())) + 1);
    }
}
