...
public interface IBmqService {
	 ...
	 */
	Recouvrement obtenirRecouvrement(Long recouvrementId);
	...
	LigneBmqTaxe trouverLigneBmqTaxe(Long ligneBmqTaxeId);

	void supprimerLigneBmqTaxe(Long ligneBmqTaxeId);
