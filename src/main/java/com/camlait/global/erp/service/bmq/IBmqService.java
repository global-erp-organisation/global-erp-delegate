...
public interface IBmqService {
     ...
     */
    Collection<LigneBmq> ajouterLigneBmq(Collection<LigneBmq> ligneBmqs) throws GlobalErpServiceException,IllegalArgumentException;
     ...
     */
    Bmq genererBmq(Long bmqId, Collection<Document> documents, Collection<Recouvrement> recouvrements) throws GlobalErpServiceException;
     ...
     */
    Recouvrement ajouterRecouvrement(Recouvrement recouvrement) throws GlobalErpServiceException,IllegalArgumentException;
     ...
     */
    Recouvrement modifierRecouvrement(Recouvrement recouvrement) throws GlobalErpServiceException,IllegalArgumentException;
    ...
    LigneBmqTaxe ajouterLigneBmqTaxe(LigneBmqTaxe ligneBmqTaxe) throws GlobalErpServiceException,IllegalArgumentException;
    
    LigneBmqTaxe modifierLigneBmqTaxe(LigneBmqTaxe ligneBmqTaxe) throws GlobalErpServiceException,IllegalArgumentException;
