...
public interface IProduitService {
     ...
     * @return
     */
    CategorieProduit obtenirCategorieProduit(Long categorieId) throws GlobalErpServiceException, IllegalArgumentException;
     ...
     * @return
     */
    CategorieProduit obtenirCategorieProduit(String codeCategorie) throws GlobalErpServiceException, IllegalArgumentException;
     ...
     * @return
     */
    Collection<CategorieProduit> listerCategorie(Long parentId) throws GlobalErpServiceException, IllegalArgumentException;
     ...
     * @return
     */
    Collection<CategorieProduit> listerCategorieProduit(String motCle) throws GlobalErpServiceException, IllegalArgumentException;
     ...
     * @return
     */
    CategorieProduitTaxe obtenirCategorieProduitTaxe(Long categorieProduitTaxeId) throws GlobalErpServiceException, IllegalArgumentException;
     ...
     * @param categorieProduitTaxeId
     */
    void supprimerCategorieProduitTaxe(Long categorieProduitTaxeId) throws GlobalErpServiceException, IllegalArgumentException;
     ...
     * @return
     */
    Collection<CategorieProduit> listerCategorie(Portee portee) throws GlobalErpServiceException, IllegalArgumentException;
