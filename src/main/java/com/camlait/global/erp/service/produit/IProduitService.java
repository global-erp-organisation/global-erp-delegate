...
public interface IProduitService {
     ...
     * @return
     */
    CategorieProduit ajouterCategorieProduit(CategorieProduit categorie) throws GlobalErpServiceException, IllegalArgumentException;
     ...
     * @return
     */
    CategorieProduit modifierCategorieProduit(CategorieProduit categorie) throws GlobalErpServiceException, IllegalArgumentException;
     ...
     * @return
     */
    Page<CategorieProduit> listerCategorieProduit(Pageable p) throws GlobalErpServiceException;
     ...
     * @return
     */
    CategorieProduitTaxe ajouterCategorieProduitTaxe(CategorieProduitTaxe categorieProduitTaxe) throws GlobalErpServiceException, IllegalArgumentException;
    
    /**
     * Modifier une collection de taxe pour une categorie de produit
     * 
     * @param categorieProduitTaxe
     * @return
     */
